    ...
    <div className="overflow-hidden pt-5">
      <div className="mb-12 flex flex-nowrap font-medium text-gray-500 w-[800px] md:w-auto md:translate-x-0!" style={translateStyle}>
        {steps.map((s, idx) => (
          <div
            key={idx}
            className={`relative md:grow flex items-center gap-4 pt-3! w-1/3 md:w-auto ${step === idx ? 'border-t-4 border-t-black' : step > idx ? 'border-t-4 border-t-greenBrand cursor-pointer' : 'border-t border-t-cd'}`}
